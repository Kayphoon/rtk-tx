...
## [0.35.0](https://github.com/Kayphoon/rtk-tx/compare/v0.34.3...v0.35.0) (2026-05-13)


### Features

* adapt rtk for CodeBuddy as rtk-tx ([cbd6023](https://github.com/Kayphoon/rtk-tx/commit/cbd602385c3f10cc782535893f60eabecc12f855))
* add CodeBuddy plugin setup ([2cb4413](https://github.com/Kayphoon/rtk-tx/commit/2cb44136c6d2a611f44aadefa9edba5e7c33d34d))
* add WorkBuddy integration support ([416151c](https://github.com/Kayphoon/rtk-tx/commit/416151ca27d32ea9de86bb8e5b3fb6f7314a9140))
* **aws:** expand CLI filters from 8 to 25 subcommands ([402c48e](https://github.com/Kayphoon/rtk-tx/commit/402c48e66988e638a5b4f4dd193238fc1d0fe18f))
* **benchmark:** add multipass VM integration test suite ([6e7863b](https://github.com/Kayphoon/rtk-tx/commit/6e7863bf313b0d18a47cf0ca2cdaea03cc2ed900))
* **benchmark:** add multipass VM integration test suite ([d22759b](https://github.com/Kayphoon/rtk-tx/commit/d22759b8c5254ad9c4a455f10cb7de75e92df581))
* **benchmark:** add Swift ecosystem tests (6 commands + savings) ([1fbb6d9](https://github.com/Kayphoon/rtk-tx/commit/1fbb6d935b4a0d031a7862cba312eebe1303ba9b))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([9e96caa](https://github.com/Kayphoon/rtk-tx/commit/9e96caa0a18a95c84da82ba57716a9d3ef86d0c8))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([bab3a53](https://github.com/Kayphoon/rtk-tx/commit/bab3a53f24f95a4a5821b23712f0b7f2ce3e0445))
* **hooks:** native hook handlers, remove bash scripts ([22892f0](https://github.com/Kayphoon/rtk-tx/commit/22892f02439fbd85593b0925e558852dafcb5da0))
* **init:** add native support for Kilo Code and Google Antigravity ([d0a3797](https://github.com/Kayphoon/rtk-tx/commit/d0a3797ec580f96948489d1e7c3329ac22a6c4eb))
* **init:** add support for kilocode and antigravity agents ([66b90f1](https://github.com/Kayphoon/rtk-tx/commit/66b90f1ed3de81acdce61164c068c24ed7ef29db))
* **js:** distinguish between `jest` and `vitest` and don't rewrite `npm test` commands as we don't know which test framework is used under the hood ([45938b2](https://github.com/Kayphoon/rtk-tx/commit/45938b2a4d3fe76685a6e008f210bb276df50319))
* **pnpm:** Add filter argument support ([2ba8d37](https://github.com/Kayphoon/rtk-tx/commit/2ba8d372df186b4056a3b8906fc25cde8586dd42))
* **pnpm:** Add filter argument support ([a39ac43](https://github.com/Kayphoon/rtk-tx/commit/a39ac4382a3d118b281ffd5e532cf93aeae2e3f0)), closes [#259](https://github.com/Kayphoon/rtk-tx/issues/259)
* **pnpm:** handle pnpm build rewrite ([f936138](https://github.com/Kayphoon/rtk-tx/commit/f93613881939bc278261e9143bd328c82c696a33))
* **refacto-core:** binary hook w/ native cmd exec + streaming ([e7b7f9a](https://github.com/Kayphoon/rtk-tx/commit/e7b7f9ab665a0f7303d41d23ad156d24e5e8964e))
* **skills:** add /pr-review skill for batch PR review ([21e67a1](https://github.com/Kayphoon/rtk-tx/commit/21e67a1113041b74542d0285e5f74587dfb30b65))
* **stream:** P1 fixes from PR [#956](https://github.com/Kayphoon/rtk-tx/issues/956) review ([71eeeda](https://github.com/Kayphoon/rtk-tx/commit/71eeedab4d771986b3d3dc5c439f5646135ff96c))
* **stream:** standardize command execution with exec_capture() ([a2312df](https://github.com/Kayphoon/rtk-tx/commit/a2312df5f2533639afd937686d94e12eab7760bd))
* take review into account ([bad5fe9](https://github.com/Kayphoon/rtk-tx/commit/bad5fe90f42b939ccf832fbb94bbe068bbc3e89d))
* **telemetry:** add retention, ecosystem, economics, and config metrics ([450ed10](https://github.com/Kayphoon/rtk-tx/commit/450ed107abb1f27270f3c968f7cde0fe8d817c0d))
* **telemetry:** enrich daily ping with gap detection and quality metrics ([644c50f](https://github.com/Kayphoon/rtk-tx/commit/644c50f786e5c567617e7ea907c5f312797b1265))
* **telemetry:** enrich daily ping with gap detection and quality metrics ([d57de86](https://github.com/Kayphoon/rtk-tx/commit/d57de86d88533413fe2b8a560713fe981de481c6))


### Bug Fixes

* add more permissions for release-please to create PRs ([26e3e59](https://github.com/Kayphoon/rtk-tx/commit/26e3e59c9669793d9b8416a835e0a15700fb1c9b))
* align rtk-tx user-facing warnings ([a4471b4](https://github.com/Kayphoon/rtk-tx/commit/a4471b4dca5fde7c5116a0a392c207d69d35be4a))
* apply clippy suggestions ([c6f35c9](https://github.com/Kayphoon/rtk-tx/commit/c6f35c9771e47e25f6284f292e9f9ddc27875de6))
* **benchmark:** address PR review feedback ([87ee81f](https://github.com/Kayphoon/rtk-tx/commit/87ee81f08be5e7b1ca79513b1a91925d455f4f5c))
* **benchmark:** address review feedback from @FlorianBruniaux ([d13c185](https://github.com/Kayphoon/rtk-tx/commit/d13c185aac64d14288b574df44623723a69e7b95))
* **ccusage:** add --yes flag and warn when falling back to npx ([f68fa00](https://github.com/Kayphoon/rtk-tx/commit/f68fa0087c03d6882993b7b3eaee98e1dbab41b4))
* **claude:** restore performance skill as directory ([b3cdde6](https://github.com/Kayphoon/rtk-tx/commit/b3cdde6a62c3cd2b2b8215e3e01099cc33589b95))
* **clippy:** show full error blocks instead of truncated headline ([95d9d13](https://github.com/Kayphoon/rtk-tx/commit/95d9d134b0b76d83b6162614b0a79269b2135f40))
* **clippy:** show full error blocks instead of truncated headline ([f4074f8](https://github.com/Kayphoon/rtk-tx/commit/f4074f898a9b73b72bbcd8b18afab4831dcda406)), closes [#602](https://github.com/Kayphoon/rtk-tx/issues/602)
* **cmd:** read/cat multiple file and consistent behavior ([3f58018](https://github.com/Kayphoon/rtk-tx/commit/3f58018f4af1d7206457929cf80bb4534203c3ee))
* **core:** error handl, RAW_CAP, recursion guard, atomic writes ([0d07f04](https://github.com/Kayphoon/rtk-tx/commit/0d07f04d03dd5f09b10dd7aea5a5479f0612da71))
* **core:** review 956 various fix ([840571f](https://github.com/Kayphoon/rtk-tx/commit/840571fe90ed14fb7e96f9b9000a1bac6d196d23))
* **curl:** skip JSON schema conversion for internal/localhost URLs ([577c311](https://github.com/Kayphoon/rtk-tx/commit/577c311ecaaa8ae94f22dbe252152424d4333d04))
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([ca4c59c](https://github.com/Kayphoon/rtk-tx/commit/ca4c59c230306d310069bed3c0ba930068dc4dc4))
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([42d3161](https://github.com/Kayphoon/rtk-tx/commit/42d3161872713bc0b20ef49b0714add40c40d5e3))
* **discover:** preserve golangci-lint flags in rewrite ([d85303e](https://github.com/Kayphoon/rtk-tx/commit/d85303ec4893deb904260f5dc11b7df906a50c07))
* **discover:** weighted savings rate per bucket, decimal already_rtk percent ([82c62eb](https://github.com/Kayphoon/rtk-tx/commit/82c62eb893966b8f170ea22ec72e79f14789e12e))
* **discover:** word boundary in exclude_commands ([0ea115b](https://github.com/Kayphoon/rtk-tx/commit/0ea115bca5fa66daa69fda2f0eeaaf103346b3a4))
* **docs:** add missing docs for exclude commands patterns ([2e401ac](https://github.com/Kayphoon/rtk-tx/commit/2e401ac38feec88de8d5e46f0301c8a532b95614))
* **docs:** clean some docs + disclaimer ([deda44f](https://github.com/Kayphoon/rtk-tx/commit/deda44f73607981f3d27ecc6341ce927aab34d37))
* **docs:** update TELEMETRY.md to match code after review fixes ([be5c057](https://github.com/Kayphoon/rtk-tx/commit/be5c0576d95566f37f266fd9f92e2a1b263697bd))
* **docs:** use release please changelog no manual ([7591a14](https://github.com/Kayphoon/rtk-tx/commit/7591a14e4ceb732ab7ca160ac01a852926abe77a))
* **docs:** user facing docs ([c8d6878](https://github.com/Kayphoon/rtk-tx/commit/c8d68787fb8b31c52125e9fc7ea62e0aa590485f))
* **find:** include hidden files when pattern targets dotfiles ([#1101](https://github.com/Kayphoon/rtk-tx/issues/1101)) ([dbeeaed](https://github.com/Kayphoon/rtk-tx/commit/dbeeaed16aee79674ec2fd3778b7b11b10b847c6))
* fix ls -la output parsing ([e6b87d4](https://github.com/Kayphoon/rtk-tx/commit/e6b87d4eb28b9a6349ad7d805edbb5fd723cb89c))
* **gh:** pass through gh pr merge instead of canned response ([#938](https://github.com/Kayphoon/rtk-tx/issues/938)) ([8465ca9](https://github.com/Kayphoon/rtk-tx/commit/8465ca953fa9d70dcc971a941c19465d456eb7d4))
* **gh:** pass through gh pr merge instead of canned response ([#938](https://github.com/Kayphoon/rtk-tx/issues/938)) ([e1f2845](https://github.com/Kayphoon/rtk-tx/commit/e1f2845df06a8d8b8325945dc4940ec5f530e4cc))
* **git:** inherit stdin for commit and push to preserve SSH signing ([#733](https://github.com/Kayphoon/rtk-tx/issues/733)) ([eefeae4](https://github.com/Kayphoon/rtk-tx/commit/eefeae45656ff2607c3f519c8eae235e3f0fe411))
* **git:** inherit stdin for commit and push to preserve SSH signing ([#733](https://github.com/Kayphoon/rtk-tx/issues/733)) ([6cee6c6](https://github.com/Kayphoon/rtk-tx/commit/6cee6c60b80f914ed9505e3925d85cadec43ab97))
* **git:** preserve full diff hunk headers ([62f4452](https://github.com/Kayphoon/rtk-tx/commit/62f445227679f3df293fe35e9b18cc5ab39d7963))
* **git:** preserve full diff hunk headers ([09b3ff9](https://github.com/Kayphoon/rtk-tx/commit/09b3ff9424e055f5fe25e535e5b60e077f8344f9))
* **git:** re-insert -- separator when clap consumes it from git diff args ([#1215](https://github.com/Kayphoon/rtk-tx/issues/1215)) ([9979c69](https://github.com/Kayphoon/rtk-tx/commit/9979c699307a4adad2c2df0f2bc3b663df653311))
* **git:** remove -u short alias from --ultra-compact to fix git push -u ([6b76fdb](https://github.com/Kayphoon/rtk-tx/commit/6b76fdb87d7c54cfc2a1b0e6117dd78b8430910b))
* **go:** avoid false build errors from download logs ([9c1cf2f](https://github.com/Kayphoon/rtk-tx/commit/9c1cf2f403534fa7874638b1b983c2d7f918a185))
* **go:** avoid false build errors from download logs ([d44fd3e](https://github.com/Kayphoon/rtk-tx/commit/d44fd3e034208e3bcd59c2c46f7720eec4f10c98))
* **go:** cover more build failure shapes ([2425ad6](https://github.com/Kayphoon/rtk-tx/commit/2425ad68e5386d19e5ec9ff1ca151a6d2c9a56d3))
* **golangci-lint:** restore run wrapper and align guidance ([4f4e4d2](https://github.com/Kayphoon/rtk-tx/commit/4f4e4d2b5a3529030fe4089f60d2f4b8740b5d53))
* **golangci-lint:** support inline global flags before run ([24f2ada](https://github.com/Kayphoon/rtk-tx/commit/24f2adaf8fb541c2564fa7dfb423947932e68fb4))
* **go:** preserve failing test location context ([1481bc5](https://github.com/Kayphoon/rtk-tx/commit/1481bc590924031456a6022510275c29c09e330e))
* **go:** preserve failing test location context ([374fe64](https://github.com/Kayphoon/rtk-tx/commit/374fe64cfbedcd676733973e81a63a6dfecbb1b7))
* **go:** prevent double-counted failures when test-level fail also triggers package-level fail ([#958](https://github.com/Kayphoon/rtk-tx/issues/958)) ([4fc15ef](https://github.com/Kayphoon/rtk-tx/commit/4fc15ef2c1c80336ffaafa4179db4cee6f39236a))
* **go:** prevent double-counting failures when package-level fail cascades from test failures ([#958](https://github.com/Kayphoon/rtk-tx/issues/958)) ([9722d5e](https://github.com/Kayphoon/rtk-tx/commit/9722d5ebd8916f9b398bdc01b1102d42ab2b8795))
* **go:** restore build error coverage ([1177c9c](https://github.com/Kayphoon/rtk-tx/commit/1177c9c873ac63b6c0bcc9e1b664a705baa0ad7a))
* **grep:** close subprocess stdin to prevent memory leak ([#897](https://github.com/Kayphoon/rtk-tx/issues/897)) ([7217562](https://github.com/Kayphoon/rtk-tx/commit/72175623551f40b581b4a7f6ed966c1e4a9c7358))
* **grep:** close subprocess stdin to prevent memory leak ([#897](https://github.com/Kayphoon/rtk-tx/issues/897)) ([09979cf](https://github.com/Kayphoon/rtk-tx/commit/09979cf29701a1b775bcac761d24ec0e055d1bec))
* **hook_check:** detect missing integrations ([9cf9ccc](https://github.com/Kayphoon/rtk-tx/commit/9cf9ccc1ac39f8bba37e932c7d318a3aa7a34ae9))
* **hook:** reduce rewrite hook spawn overhead ([b3a7e75](https://github.com/Kayphoon/rtk-tx/commit/b3a7e753fe97f9265be94c8bfeffd62099abb83c)), closes [#968](https://github.com/Kayphoon/rtk-tx/issues/968)
* **hooks:** add regression test for windows native ([115e448](https://github.com/Kayphoon/rtk-tx/commit/115e44853b8cdd2d7af3af2b52c9c31e924a45d3))
* **hooks:** ensure default permission verdict prompts user for confirmation ([40462c0](https://github.com/Kayphoon/rtk-tx/commit/40462c05e66f116928de365a0d271bdfd61cec72))
* **hooks:** permission checks, audit log injection, stdin limits ([41ebf0b](https://github.com/Kayphoon/rtk-tx/commit/41ebf0babbf6aee21a267230e8c101cc67f6b6a2))
* **hooks:** reduce jq invocations in rtk-rewrite\n\nFixes [#968](https://github.com/Kayphoon/rtk-tx/issues/968) ([74a1fd2](https://github.com/Kayphoon/rtk-tx/commit/74a1fd2765b235267aacf9a55aa6024c0590f003))
* **hooks:** require all segments to match allow rules ([#1213](https://github.com/Kayphoon/rtk-tx/issues/1213)) ([40c9dbc](https://github.com/Kayphoon/rtk-tx/commit/40c9dbc7dbbf9332d6859060765c582a880f0fde))
* **hooks:** windows use 'rtk hook claude' no fallback ([da3c432](https://github.com/Kayphoon/rtk-tx/commit/da3c432201240f0da9627d8cc6bc70e5b7f8bdfe))
* **hooks:** windows use 'rtk hook claude' no fallback ([0e29650](https://github.com/Kayphoon/rtk-tx/commit/0e29650e11959730f4c4a2e6d6c0519e14dc8595))
* **init:** honor CODEX_HOME for Codex global paths ([d442799](https://github.com/Kayphoon/rtk-tx/commit/d442799e34d522c87a6eb60c2ff373385d201315))
* **init:** install Codex global instructions in CODEX_HOME ([a257688](https://github.com/Kayphoon/rtk-tx/commit/a2576883a27c5f915ba0ae7883a51006411b3ae5))
* **init:** remove opt-out instruction from telemetry message ([7571c8e](https://github.com/Kayphoon/rtk-tx/commit/7571c8e101c41ee64c51e2bd64697f85f9142423))
* **init:** remove telemetry info lines from init output ([7dbef2c](https://github.com/Kayphoon/rtk-tx/commit/7dbef2ce00824d26f2057e4c3c76e429e2e23088))
* isolate cursor hook tests from local settings (determinist) ([d8ddefe](https://github.com/Kayphoon/rtk-tx/commit/d8ddefe78efe25c35bb2a2f9083f2eacb9dd7274))
* **json:** rename --schema to --keys-only, closes [#621](https://github.com/Kayphoon/rtk-tx/issues/621) ([c16713a](https://github.com/Kayphoon/rtk-tx/commit/c16713a973b563a6cba283c830b67c8c470e419f))
* **ls:** filter quality wrong truncation ([aa6317f](https://github.com/Kayphoon/rtk-tx/commit/aa6317fb83a5d9883623a4d3bee7a25bc99dcb4c))
* **main:** kill zombie processes + path for rtk md ([d16fc6d](https://github.com/Kayphoon/rtk-tx/commit/d16fc6dacbfec912c21522939b15b7bbd9719487))
* **main:** kill zombie processes + path for rtk md + missing intergrations ([a919335](https://github.com/Kayphoon/rtk-tx/commit/a919335519ed4a5259a212e56407cb312aa99bac))
* **merge:** changelog conflicts ([d92c5d2](https://github.com/Kayphoon/rtk-tx/commit/d92c5d264a49483c8d6079e04d946a79bc990a74))
* P0+P1 fixes from pre-merge review of hook engine ([df8e035](https://github.com/Kayphoon/rtk-tx/commit/df8e03558d4d6cc2f5cbac91c63ab1b3b51d3bcd))
* P0+P1 fixes from pre-merge review of hook engine ([d34389c](https://github.com/Kayphoon/rtk-tx/commit/d34389c3d0936c2b0790e14f450bb50a28a7edf7))
* **permissions:** glob_matches middle-wildcard matches commands without trailing args ([#1105](https://github.com/Kayphoon/rtk-tx/issues/1105)) ([3db8070](https://github.com/Kayphoon/rtk-tx/commit/3db8070b51b9a312fcca20a8460d3d6259cc38b7))
* **pnpm:** list command not working ([ba235d8](https://github.com/Kayphoon/rtk-tx/commit/ba235d85974c0a85b25e290a8bb83648800438a6))
* **proxy:** kill child process on SIGINT/SIGTERM to prevent orphans ([d813919](https://github.com/Kayphoon/rtk-tx/commit/d813919a24546e044e7844fc7ed05fef4ec24033))
* **proxy:** kill child process on SIGINT/SIGTERM to prevent orphans ([3318510](https://github.com/Kayphoon/rtk-tx/commit/33185101fc122d0c11a25a4e02ac9f3a7dc7e3bb))
* **pytest:** -q mode summary line not detected ([57502a5](https://github.com/Kayphoon/rtk-tx/commit/57502a5bef1fb56109a57cf2ea7377fd271253a7))
* remove legacy tracking db fallback ([53adbb0](https://github.com/Kayphoon/rtk-tx/commit/53adbb047ef92ec14cd06593cdcc8ebf43f7bffc))
* remove pnpx -&gt; rtk pnpx rule as rtk pnpx command doesn't exist ([325a42e](https://github.com/Kayphoon/rtk-tx/commit/325a42e09fd8de6d0c26914ff29ab11d8680f354))
* rename ship.md to ship/SKILL.md to match develop ([5916ecd](https://github.com/Kayphoon/rtk-tx/commit/5916ecd86fb319c2519a0b4fb2891309833a3bb4))
* report package-level failures (timeouts, signals) in go test summary ([0b1c32b](https://github.com/Kayphoon/rtk-tx/commit/0b1c32b3cc9a3e73418d401d1d481c1611c7ec0b))
* report package-level failures (timeouts, signals) in go test summary ([c85a387](https://github.com/Kayphoon/rtk-tx/commit/c85a387363e2079234b6141aad26418172c0e61a)), closes [#958](https://github.com/Kayphoon/rtk-tx/issues/958)
* **review:** address ChildGuard disarm, stdin dedup, hook masking ([d85fe33](https://github.com/Kayphoon/rtk-tx/commit/d85fe3384b87c16fafd25ec7bcadbff6e69f3f1f))
* **runner:** preserve fd separation on command failure ([e92d099](https://github.com/Kayphoon/rtk-tx/commit/e92d0993c93f0b732316dfa932d265aeca7488d6))
* **security:** correct email domain from .dev to .app ([47383e8](https://github.com/Kayphoon/rtk-tx/commit/47383e80197fc56e38f880f33a6b54261b82523c))
* **security:** default to ask when no permission rule matches ([#886](https://github.com/Kayphoon/rtk-tx/issues/886)) ([158c745](https://github.com/Kayphoon/rtk-tx/commit/158c74527f6591d372e40a78cd604d73a20649a9))
* **security:** default to ask when no permission rule matches ([#886](https://github.com/Kayphoon/rtk-tx/issues/886)) ([41a6c6b](https://github.com/Kayphoon/rtk-tx/commit/41a6c6bf6da78a4754794fdc6a1469df2e327920))
* **stream:** missing stderr fields ([a1d46f3](https://github.com/Kayphoon/rtk-tx/commit/a1d46f39c291e3356b9c26a062bde05ba1de591a))
* **stream:** P0 fixes from PR [#956](https://github.com/Kayphoon/rtk-tx/issues/956) review ([2bb5265](https://github.com/Kayphoon/rtk-tx/commit/2bb5265595c4a80fe1ad7e9ab3ffc8dd013b019c))
* **stream:** skip printf-based tests on Win ([63313a2](https://github.com/Kayphoon/rtk-tx/commit/63313a25b6e15749fe047376414a9bd6bdf811a7))
* **stream:** stream engine & template + BlockHandler, RegexBlockFilter, signal guard, pipe rewrite ([b3936b8](https://github.com/Kayphoon/rtk-tx/commit/b3936b8e5d5fc2b5036b90aada61917fa3f3f7de))
* **stream:** wire run_streaming as standard exec for filter commands ([02e3a6f](https://github.com/Kayphoon/rtk-tx/commit/02e3a6f8f4639c86a585701cf5ed03c0f853e752))
* **tee:** prevent panic on UTF-8 multi-byte truncation boundary ([da486bf](https://github.com/Kayphoon/rtk-tx/commit/da486bf394330c804cd1cd12e4b6835f18de5205))
* **telemetry:** 7 bugs in enrichment — privacy leak, broken meta_usage, pricing ([15f666d](https://github.com/Kayphoon/rtk-tx/commit/15f666dd8dbd18648cb7bd14a6f9f3cac2f7d10b))
* **telemetry:** clean code ([8156081](https://github.com/Kayphoon/rtk-tx/commit/81560812610686fa5ca3633c2bf0b79c05eaa7d9))
* **telemetry:** consent, erasure, auth, docs ([2e4cc4b](https://github.com/Kayphoon/rtk-tx/commit/2e4cc4bb5226444c8c0bfc827baf0c101c3759e8))
* **telemetry:** non-terminal consent, single config load ([7821e98](https://github.com/Kayphoon/rtk-tx/commit/7821e9872fd1f1ae9b40eb8a4458049869acc36b))
* **telemetry:** RGPD-compliant, consent gate, erasure, privacy controls ([6a5bc84](https://github.com/Kayphoon/rtk-tx/commit/6a5bc847e06cf6066e6f4aeed5a3ad0803a3649b))
* **tests:** windows regression test fix path ([13a73dd](https://github.com/Kayphoon/rtk-tx/commit/13a73ddfd78460560a1f5fde94b54b1f848b41b5))
* **tracking:** use std::env::temp_dir() for compatibility (instead of unix tmp) ([e918661](https://github.com/Kayphoon/rtk-tx/commit/e918661440d7b50321f0535032f52c5e87aaf3cb))
* **vitest:** rework command to handle differences between vitest and jest ([70610da](https://github.com/Kayphoon/rtk-tx/commit/70610da4bbf0fd8f4226fc61895af61377eafcc8))
