...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk-tx golangci-lint run",
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk-tx ansible-playbook",
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk-tx fail2ban-client",
...
pub const IGNORED_EXACT: &[&str] = &[
    "cd", "echo", "true", "false", "wait", "pwd", "bash", "sh", "fi", "done", "rtk-tx", "rtk",
];
